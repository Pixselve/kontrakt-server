...
export class SkillToStudentUpdateManyWithoutStudentInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [SkillToStudentUpdateWithWhereUniqueWithoutStudentInput],
    {
      nullable: true,
      description: undefined,
    }
  ...
  update?:
    | SkillToStudentUpdateWithWhereUniqueWithoutStudentInput[]
    | null
    | undefined;
  ...
  @TypeGraphQL.Field(
    (_type) => [SkillToStudentUpsertWithWhereUniqueWithoutStudentInput],
    {
      nullable: true,
      description: undefined,
    }
  ...
  upsert?:
    | SkillToStudentUpsertWithWhereUniqueWithoutStudentInput[]
    | null
    | undefined;
}
